...
**تطبيق ويب تقدمي (PWA) بسيط وعصري مخصص لمواقيت الصلاة في المحافظات السورية.**
...
* **🇸🇾 تغطية شاملة:** يدعم جميع المحافظات السورية الرئيسية (حلب، دمشق، حمص، حماة، اللاذقية، إلخ).
